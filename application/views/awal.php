...
<head>
	...
	<!-- Favicon-->
	<link rel="shortcut icon" href="assets/awal/img/fav.png">
	<!-- Author Meta -->
	...
	<meta charset="UTF-8">
	<!-- Site Title -->
	<title>Perpustakaan kebon Pedes</title>
	...
	<link rel="stylesheet" href="assets/awal/css/linearicons.css">
	<link rel="stylesheet" href="assets/awal/css/font-awesome.min.css">
	<link rel="stylesheet" href="assets/awal/css/bootstrap.css">
	<link rel="stylesheet" href="assets/awal/css/magnific-popup.css">
	<link rel="stylesheet" href="assets/awal/css/nice-select.css">
	<link rel="stylesheet" href="assets/awal/css/animate.min.css">
	<link rel="stylesheet" href="assets/awal/css/owl.carousel.css">
	<link rel="stylesheet" href="assets/awal/css/main.css">
</head>
...
<body>
	...
	<header id="header">
		<div class="container">
			<div class="row align-items-center justify-content-between d-flex">
				<div id="logo">
					<a href="index.html"><img src="assets/awal/img/logo.png" alt="" title="" /></a>
				</div>
	...
	<section class="home-banner-area relative">
		<div class="container">
			<div class="row fullscreen d-flex align-items-center justify-content-center">
				<div class="banner-content col-lg-8 col-md-12">
					<h1 class="wow fadeIn" data-wow-duration="4s">Selamat Datang<br>Semoga Bermanfaat</h1>
		...
		<div class="rocket-img">
			<img src="assets/awal/img/rocket.png" alt="">
		</div>
	</section>
	<!-- End Banner Area -->
		...
		<div class="container">
			<div class="row align-items-center justify-content-center">
				<div class="col-lg-5 col-md-6 about-left">
					<img class="assets/awal/img-fluid" src="img/about.jpg" alt="">
				</div>
				<div class="offset-lg-1 col-lg-6 offset-md-0 col-md-12 about-right">
					...
					<a href="courses.html" class="primary-btn"></a>
				</div>
			</div>
		</div>
	</section>
		...
		<div class="container">
			<div class="row align-items-center">
				<div class="col-lg-5 about-right">
					...
					<a href="courses.html" class="primary-btn white"></a>
				</div>
			...
			<div class="testi-slider owl-carousel" data-slider-id="1">
				<div class="item">
					<div class="testi-item">
						<img src="assets/awal/img/quote.png" alt="">
						<h4>Fanny Spencer</h4>
						<ul class="list">
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p>
	...
	<script src="assets/awal/js/vendor/jquery-2.2.4.min.js"></script>
	<script src="https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.12.9/umd/popper.min.js" integrity="sha384-ApNbgh9B+Y1QKtv3Rn7W3mgPxhU9K/ScQsAP7hUibX39j7fakFPskvXusvfa0b4Q"
	 crossorigin="anonymous"></script>
	<script src="assets/awal/js/vendor/bootstrap.min.js"></script>
	<script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBhOdIF3Y9382fqJYt5I_sswSrEw5eihAA"></script>
	<script src="assets/awal/js/easing.min.js"></script>
	<script src="assets/awal/js/hoverIntent.js"></script>
	<script src="assets/awal/js/superfish.min.js"></script>
	<script src="assets/awal/js/jquery.ajaxchimp.min.js"></script>
	<script src="assets/awal/js/jquery.magnific-popup.min.js"></script>
	<script src="assets/awal/js/owl.carousel.min.js"></script>
	<script src="assets/awal/js/owl-carousel-thumb.min.js"></script>
	<script src="assets/awal/js/jquery.sticky.js"></script>
	<script src="assets/awal/js/jquery.nice-select.min.js"></script>
	<script src="assets/awal/js/parallax.min.js"></script>
	<script src="assets/awal/js/waypoints.min.js"></script>
	<script src="assets/awal/js/wow.min.js"></script>
	<script src="assets/awal/js/jquery.counterup.min.js"></script>
	<script src="assets/awal/js/mail-script.js"></script>
	<script src="assets/awal/js/main.js"></script>
</body>
