...
<body>
    <div class="navbar navbar-default">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="<?php echo site_url('');?>"><strong>Perpustakaan kebon Pedes</strong></a>
        </div>
...
<div class="row">
                    ...
                    <div class="form-group last">
                        <div class="col-sm-offset-3 col-sm-9">
                            <button type="submit" name="proses" class="btn btn-success btn-sm">
                                ...
                                Reset</button>
                                <button type="text" class="btn btn-warning btn-sm">
                                <a href="<?= base_url('awal') ;?>">Back</a></button>
                        </div>
                    </div>
                </form>
            </div>
    ...
    <div class="col-md-8 ">
        ...
        <img src="<?php echo base_url(); ?>assets/img/banner/img2.jpg" alt="Belum Tersedia" class="img-responsive">
    </div>
</div>
</div>
